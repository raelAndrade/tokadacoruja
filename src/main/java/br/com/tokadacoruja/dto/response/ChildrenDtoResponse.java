package br.com.tokadacoruja.dto.response;
...
public class ChildrenDtoResponse implements Serializable {
	...
	public static Children from(final ChildrenDtoResponse children) {
		return Children.of(
				children.getName(),
				children.getDateBirth(), 
				children.getAllergy(), 
				children.getAllergyDescription(), 
				children.getFood(), 
				children.getFoodRestriction(), 
				children.getFoodRestrictionDescription(), 
				children.getObservation(),
				children.getPublicity(),
				children.getParent(),
				children.getStatus());
	}
