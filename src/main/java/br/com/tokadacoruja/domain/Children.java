...
public class Children implements Serializable {
	...
	public Children(final Long id, final String name, final Date dateBirth, final Boolean status, final Boolean allergy, final String allergyDescription,
			final String food, final Boolean foodRestriction, final String foodRestrictionDescription, final String observation, final String publicity, final Parent parent) {
		this.id = id;
		this.name = name;
