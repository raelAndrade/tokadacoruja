...
insert into user (usr_active, usr_email, usr_name, usr_password) values(true,'teste@teste.com', 'israel', '$2a$10$nB.uwPV/x5FCJfGNvAos2OfVQ4drQNPTZOUQsaYAOXxBvl11T8tUi');
